...
<h1>Admin panel</h1>
    ...
    <div class="container mt-5">
        <div class="row mb-3">
        <div class="col">
            <a href="user_create.php" class="btn btn-primary">Create Admin</a>
        </div>
        </div>
        <div class="row">
            <div class="col">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row["type"] . "</td>";
                    echo "<td>";
                    echo "<a href= 'user_show.php?id=" . $row["id"] . "' class = 'btn btn-primary btn-sm mr-2'>View</a>";
                    echo "<a href= 'user_edit.php?id=" . $row["id"] . "' class = 'btn btn-info btn-sm mr-2'>Edit</a>";
                    echo "<a href= 'user_delete.php?id=" . $row["id"] . "' class = 'btn btn-danger btn-sm mr-2'>Delete</a>";
                    echo "</td>";
                    echo "</tr>";
                }
            } else {
