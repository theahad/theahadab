...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $product_img = htmlspecialchars(basename($_FILES["ProductImage"]["name"]));

    $sql = "INSERT INTO product (ProductName, C_ID, ManufacturingDate, ExpiryDate, Price, product_img) VALUES ('$ProductName', '$C_ID', '$ManufacturingDate', '$ExpiryDate', '$Price', '$product_img')";
...
<h1>Admin panel</h1>
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Create Products</a>
            <!-- Profile Dropdown -->
