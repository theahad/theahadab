...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE company SET C_name=?, C_location=? WHERE C_ID=?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssi", $C_name, $C_location, $C_ID);
...
?>
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Company Edit</a>
            <!-- Profile Dropdown -->
    ...
    <form action=<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> method="POST">
        ...
        <input type="text" name="C_location" value="<?php echo $C_location; ?>" required><br>
