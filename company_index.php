...
<h1>Admin panel</h1>
    ...
    <div class="container mt-5">
        ...
        <?php if ($_SESSION["type"] !== 'customer') { ?> 
            <a href="company_create.php" class="btn btn-primary">Create company</a>
        <?php } ?>
        </div>
        </div>
        <div class="row">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>";
                    echo "<a href= 'company_show.php?id=" . $row["C_ID"] . "' class = 'btn btn-primary btn-sm mr-2'>View</a>";
                    if ($_SESSION["type"] !== 'customer') { 
                    echo "<a href= 'company_edit.php?id=" . $row["C_ID"] . "' class = 'btn btn-info btn-sm mr-2'>Edit</a>";
                    echo "<a href= 'company_delete.php?id=" . $row["C_ID"] . "' class = 'btn btn-danger btn-sm mr-2'>Delete</a>";
                }
                    echo "</td>";
                    echo "</tr>";
                }
            } else {
                echo "<tr><td colspan='7'>No company found</td></tr>";
            }
            ?>
        </tbody>
                </table>
